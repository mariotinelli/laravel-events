...
<div class="w-50 mx-auto">
    ...
    <form method="POST" class="event-form" id="event-form" action={{route('events.store')}} enctype="multipart/form-data">
        @csrf
        @method('PUT')
    ...
    $(document).ready(function(e) {
        ...
        $('#saveEvent').click(function(e) {
                ...
                if (isFormValid(form)) {
                    ...
                    // const idEvent = @js($event->id_event);
                    ...
                    $.ajax({
                        ...
                        url: '{{ route('events.update', $event->id_event) }}',
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
